...
public class Template1Fragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		AntiAliasTextView aliasTextView1= (AntiAliasTextView) rootView.findViewById(R.id.anti_textview1);
		Log.d("dizhidizhi", Environment.getExternalStorageDirectory().getAbsolutePath().toString()+"/DCIM/Camera/IMG20160101215626.jpg");
		aliasTextView1.setBackground(getPicture());
	...
	private Drawable getPicture(){
		...
		String filepath= Environment.getExternalStorageDirectory().getAbsolutePath().toString()+"/bluetooth/MYXJ_20150930161913_fast.jpg";
